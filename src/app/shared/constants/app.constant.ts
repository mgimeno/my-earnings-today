...
export interface EarningTile {
  codeName: string;
  title: string;
  amountProperty: EarningTileAmountProperty;
  totalAmountProperty: EarningTileTotalAmountProperty | null;
}
...
export namespace AppConstants {
  export class Common {
    ...
    public static readonly TILES: EarningTile[] = [
      {
        codeName: 'stopwatch',
        title: $localize`:@@tiles.stopwatch:Stopwatch`,
        amountProperty: 'stopwatchAmount',
        totalAmountProperty: null,
      },
      {
        codeName: 'hour',
        title: $localize`:@@tiles.this-hour:This hour`,
        amountProperty: 'currentHourAmount',
        totalAmountProperty: 'totalHourAmount',
      },
      {
        codeName: 'today',
        title: $localize`:@@tiles.today:today`,
        amountProperty: 'currentDayAmount',
        totalAmountProperty: 'totalDayAmount',
      },
      {
        codeName: 'week',
        title: $localize`:@@tiles.this-week:This week`,
        amountProperty: 'currentWeekAmount',
        totalAmountProperty: 'totalWeekAmount',
      },
      {
        codeName: 'month',
        title: $localize`:@@tiles.this-month:This month`,
        amountProperty: 'currentMonthAmount',
        totalAmountProperty: 'totalMonthAmount',
      },
      {
        codeName: 'year',
        title: $localize`:@@tiles.this-year:This year`,
        amountProperty: 'currentYearAmount',
        totalAmountProperty: 'totalYearAmount',
      },
    ];
